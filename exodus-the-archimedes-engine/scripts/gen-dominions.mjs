...
const dir = path.join(__dirname, "..", "pages", "factions");
...
const dominions = [
  {
    ...
    infobox: [
      ...
      ["Book role", "First flags Dolod; Tinaja / HeSea science; endgame pursuit of Diligent"],
    ],
    ...
    sections: [
      {
        ...
        paras: [
          `Excerpt lore: Heresy citizens are close to three meters tall with spindly six-limb builds (two legs, four arms), lower body temperatures, and expanded skulls. Their ships can outscale Crown counterparts such as the <em>Alumata</em>; individual hulls carry heavy defensive systems because the Heresy fields fewer traditional war fleets.`,
  ...
  },
  {
    ...
    infobox: [
      ...
      ["Also styled", "Talloch-Te; Tallach-Te (variant spellings in recaps)"],
      ["Profile", "Traders and shipbuilders; physically likened to nomadic Mara Yama in secondary lore"],
      ...
      ["Economic edge", "Largest ship fabrication industry within ~20 light-years (excerpt claim)"],
      ["Book role", "HeSea access politics; ZPZ denial vs Diligent; Traveler tasking; Dolod chase"],
    ],
    ...
    sections: [
      {
        ...
        paras: [
          `Secondary sources describe Talloch-Te as careful traders rather than open conquerors, with body plans and lifestyle compared to the space-citadel nomadism of the Mara Yama. The book stresses industrial fact more than aesthetics: Talloch-Te consume large amounts of helium-3 and can supply scoopships and hulls at scale.`,
        ],
      },
      {
        h2: "Verak alignment and the HeSea",
        paras: [
          `Excerpt diplomacy: Wynid ↔ Heresy, Verak ↔ Talloch-Te. If iron-exotic Dolod cheapens Anoosha ore (Verak asset), Carolien as empress might favor Talloch-Te access to the Crown’s HeSea monopoly — a policy other queens would treat as Accord-breaking. Sahdiah’s intelligence work sits inside that economic war even when he never holds a Crown throne.`,
        ],
      },
      {
  ...
  },
  {
    ...
    infobox: [
      ...
      ["Lifestyle", "Massive space citadels; no conventional planetary “homeworld” image in public trailers"],
      ...
      ["Soft uncertainty", "On-page presence is mostly rumor, warning, and political instrument — not a POV culture"],
    ],
    ...
    sections: [
      {
        ...
        paras: [
          `Official and trailer materials present Mara Yama as terrifying Celestials who live in hidden space citadels rather than ordinary territorial homeworlds. Secondary commentary groups them with Talloch-Te as nomadic body-plan cousins; Celestial in-book attitudes treat them as something between strategic rival and horror story.`,
        ],
      },
      {
        h2: "Instrument of Crown hardliners",
        paras: [
          `Helena-Thyra cites increasing Mara Yama activity when seizing Wynid. She proposes annexing Capo Frois and the <a href="uthara-dominion.html">Uthara Dominion</a> (the Mara Yama’s original target before they “stopped” at Hoa Quinzu, in recap framing), false-flag destabilization, and massing all queens’ fleets at Kelowan a decade ahead of a supposed confrontation.`,
          `At Hoa Quinzu the Ratarajan warn the Diligent that Mara Yama forces orbit de Verya to refuel — a concrete theater touch that keeps the threat from being pure propaganda even while Thyra exploits it.`,
        ],
      },
      {
        h2: "What the novel does not resolve",
        paras: [
          `The book does not deliver a full Mara Yama invasion POV. Their narrative function is pressure: they make hardline expansion and fleet theater legible, and they keep Capo Frois / Hoa Quinzu on the strategic map when the Diligent flees. Soft uncertainty remains about how much Mara Yama activity is real versus inflated by Bekket-network politics.`,
        ],
      },
    ],
    seeAlso: [
  ...
  },
  {
    ...
    infobox: [
      ...
      ["Notable project", "Megastructure / Dyson sphere under construction (excerpt)"],
  ...
  },
  {
    ...
    infobox: [
      ...
      ["Strategic frame", "Mara Yama’s “original target” before Hoa Quinzu pause (recap)"],
      ["Soft uncertainty", "Little on-page internal culture; known via Crown expansion rhetoric"],
    ],
    ...
    sections: [
      {
        ...
        paras: [
          `Uthara is not given a full court cast in public recaps. Its importance is geopolitical: hardliners treat it as annexable mass, and timeline material links Mara Yama’s earlier vector toward Uthara before activity concentrates near Hoa Quinzu. The Diligent’s late flight toward Capo Frois places human rebels on the edge of the same contested map.`,
        ],
      },
    ],
    seeAlso: [
  ...
  },
  {
    ...
    infobox: [
      ["Type", "Celestial dominion"],
      ["Book theater", "Hoa Quinzu system — warns Diligent of Mara Yama presence"],
    ...
    sections: [
      {
        ...
        paras: [
          `The Ratarajan appearance is brief but structural: it proves Mara Yama activity is not only Wynid propaganda, and it raises the stakes of the Kajval extraction under ghost and saberstone fire. Soft uncertainty applies to Ratarajan internal politics; confirmed is their role as the local dominion voice the Diligent must heed while deep in foreign space.`,
        ],
      },
    ],
    seeAlso: [
    ...
    sections: [
      {
        ...
        paras: [
          `Olomo’s briefing: planets do not naturally sit in life bands; the Elohim moved them. Archimedes Engines still attached to bodies such as Dolod can perform momentum transfers millennia later. Crown and Heresy astronomers treat Elohim works as both resource and hazard.`,
        ],
      },
      {
        h2: "Remnant inheritance",
        paras: [
          `Official Traveler lore: today’s great Dominions are shadows of older empires; Remnants can save or destroy. The Elohim sit at the top of that inheritance stack — the reason livable worlds exist for Celestials to rule and late arkships to covet.`,
        ],
      },
    ],
    seeAlso: [
