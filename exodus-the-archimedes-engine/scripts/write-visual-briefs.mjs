...
const briefs = [
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Liliana, Lidon-linked human mercenary. HER FIELD KIT IS A BIOWARE MUSCLE SUIT, NOT ARMOUR: a close-fitting lightweight suit of sculpted fibre bundles that reads as exposed anatomy — as though a powerfully built wrestler had been skinned — with NO plates, NO cuirass, NO rigid armour panels and no emblems anywhere on it. HER CHERENKOV BLADE IS FULLY SHEATHED at the hip: compact high-tech powered knife about 20cm, entire blade hidden in a slim far-future black tech sheath with only the grip visible, point DOWN — NOT drawn, NOT unsheathed, NOT a bare blade pointing up, NOT a machete. Striking woman with a cool professional expression. Deniable operator, unsettling to look at. Windy hatch light and cloud haze. ${NO_TEXT_ANYWHERE}`,
    inference: [
