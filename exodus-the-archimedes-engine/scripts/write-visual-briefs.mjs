...
const briefs = [
  ...
  },
  {
    ...
    prompt: `${STYLE} Exterior plate of Arcadia’s Moon, a Traveler deniable charter starship: mid-size modular freighter-explorer hull with cargo pods, articulated salvage arms, worn civilian plating in charcoal and amber, independent ship character. Three-quarter view near a ringed gas giant, deep space lighting.`,
    inference: [],
