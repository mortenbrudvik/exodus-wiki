...
const briefs = [
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Inessa-Pierina, Imperial Celestial queen of Cheluli. SHE IS AN IMPERIAL CELESTIAL, NOT AN ORDINARY HUMAN: close to three metres tall, with elongated proportions, long limbs, a long neck and unnaturally refined post-human features — not a human woman in costume. HER SKIN IS RED: a deep warm oxblood-and-terracotta red complexion, unmistakably red-hued rather than brown, olive or any ordinary human tone. HER BLOODSTONE IS ORANGE, NOT TURQUOISE AND NOT GREEN: a wide starburst of burnt-orange bloodstone horns radiating outward all around her head like a crude, heavy, unfinished sculpture — a matte porous calcium growth of the body, never a cut, faceted or polished gemstone, never set in metal like jewellery, and never a red gem. The horns must stay clearly distinct and readable against her red skin — brighter and more saturated than it, never blending into it. Blunt, impatient expression, white and copper court robes. The least polished of the peer queens. Plain even light, uncluttered background, no heraldic emblems, no crests, no repeated motifs, no banners, no murals, no floating symbols or runes.`,
    inference: [
