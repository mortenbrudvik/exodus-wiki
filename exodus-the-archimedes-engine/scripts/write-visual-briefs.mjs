 ...
 */
/**
 * The clade, material and period clauses now live in lib/prompt-parts.mjs so the extras generator
 * can use the same strings. See that file for why each is worded the way it is.
 *
...
const briefs = [
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Terence Wilson-Fletcher, a 24-year-old detective on a far-future colony city: sharp-eyed young man with a thoughtful intense expression, short neat hair and FAIR, LIGHT-TONED SKIN. HIS CLOTHES ARE FAR-FUTURE, NOT PRESENT-DAY: a dark weatherproof investigator coat-tunic with a standing collar and an ASYMMETRIC diagonal closure, seamed structural panels, and an unfamiliar fastening — over a smooth high-necked under-tunic. NOT a trench coat, no notch lapels, no storm flap, no belted waist, no zip front, no row of buttons down the centre, no patch pockets, no knitted turtleneck or roll-neck sweater, no modern parka or field-jacket cut. Subtle glowing in-ear device. ${FAR_FUTURE_DRESS} Human investigator aesthetic. A rain-wet street at night behind him, thrown far out of focus into soft coloured bokeh with no legible shapes — no shop signs, no neon lettering, no billboards, no screens. ${NO_TEXT_ANYWHERE}`,
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Luus-Marcela, Imperial Celestial Now and Forever Queen of Bassa. ${CELESTIAL_BODY} SHE IS A GROWN WOMAN WITH A BEGUILINGLY YOUNG FACE: smooth, unlined, almost girlish features on an adult woman — disarmingly youthful, and absolutely NOT a child, NOT prepubescent, NOT an adolescent, and not a lined or middle-aged woman either. She has long hair, not a bald or shaven head, and an adult woman's head and jaw, not a child's rounded skull. On that beguilingly young, almost girlish face she wears an expression of hard political triumph that does not belong on it, and that contrast is the point of the picture. Tall elegant post-human sovereign, emerald and gold robes with ${bloodstone("diadem")}. Plain even light, uncluttered background, no heraldic emblems, no crests, no repeated motifs, no banners, no murals, no floating symbols or runes. ${NO_TEXT_ANYWHERE}`,
    sources: [
      "The novel gives her **\"a beguilingly young, almost girlish face\"** and no age. An earlier prompt here said \"the face of a girl of about seventeen\" — that seventeen was imported from Carolien-Amaia, whose host body the book does fix at seventeen, and it produced a portrait of a child. Do not attach a number to Luus",
    ],
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Inessa-Pierina, Imperial Celestial queen of Cheluli. SHE IS AN IMPERIAL CELESTIAL, NOT AN ORDINARY HUMAN: close to three metres tall, with elongated proportions, long limbs, a long neck and unnaturally refined post-human features — not a human woman in costume. HER SKIN IS FAIR WITH A RED TINT: a pale, light complexion suffused with a warm rosy-coppery red undertone — clearly tinted red, but light-skinned overall, never a deep oxblood, terracotta or dark red complexion. HER BLOODSTONE IS ORANGE, NOT TURQUOISE AND NOT GREEN: a wide starburst of burnt-orange bloodstone horns radiating outward all around her head like a crude, heavy, unfinished sculpture — a matte porous calcium growth of the body, never a cut, faceted or polished gemstone, never set in metal like jewellery, and never a red gem. The horns must stay clearly distinct and readable against her pale skin — deeper and more saturated than it, never blending into it. SHE STANDS FULLY UPRIGHT WITH A REGAL BEARING: squared shoulders, a straight back, a long neck held high, chin level — commanding and sovereign. Never hunched, never stooped, never slouching or craning forward. Her face carries strong noble bone structure and unmistakable royal authority, and on it sits a blunt, impatient expression: she is the least *polished* of the peer queens in manner, never the least noble in breeding or bearing. White and copper court robes. Plain even light, uncluttered background, no heraldic emblems, no crests, no repeated motifs, no banners, no murals, no floating symbols or runes.`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Ramona-Ursule, Imperial Celestial queen of Nizinsk. ${CELESTIAL_BODY} Tall post-human woman with sharp assessing eyes, amethyst and silver robes, ${bloodstone("collar")}. Host of multi-dominion politics trial, cool chamber light. ${NO_TEXT_ANYWHERE}`,
    inference: [],
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Zuberi-Dulcina, historical Imperial Celestial queen of Kelowan. ${CELESTIAL_BODY} ABSOLUTELY NO SYMBOLS ANYWHERE: no runes, no glyphs, no floating characters, no sunburst or star emblems, no heraldry, no inscriptions, no lettering of any kind, in the air or on the walls or on her armour. HER SKIN IS DARK ASHEN: a deep ash-grey complexion, cool and dark like cooled ash or slate — not warm brown, not olive, not ordinary human skin. A war sovereign with a very long neck, elongated skull and limbs and refined post-human features, standing upright with a tragic commanding expression, blackened-gold armour robes, ${bloodstone("cracked crown")}. Fallen empire grandeur, smoky dramatic light, plain uncluttered background.`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Lord Jolav, Imperial Celestial consort to a queen. ${CELESTIAL_BODY} Tall elegant post-human man with restrained worried dignity, silver-black consort robes, ${bloodstone("subtle collar ornament")}. Quiet opposition energy, soft anteroom light against a plain bare wall. ${FAR_FUTURE_DRESS} ${NO_TEXT_ANYWHERE}`,
    inference: [],
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Makaio-Yalbo, Imperial Celestial archon spymaster near the end of his host body. ${CELESTIAL_BODY} Tall post-human man whose skull and cheeks are almost entirely encased in pale calcium-like bloodstone, leaving only his mouth, nose and piercing eyes uncovered, with a crown of scalloped horns curling around one another above it, faintly tinted turquoise and gold; his neck and body are brocaded with the same growth in a lacework pattern beneath a formal toga. Rigid, expressionless, immensely powerful. Upper-body portrait, dim shipboard intelligence-suite light.`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Neusch, young Imperial Celestial son of a spymaster archon. ${CELESTIAL_BODY} Tall young post-human man with intense focused eyes, dark slim coat, glowing neural-gift collar, elongated proportions. ${BLOODSTONE_GUARD}. Investigator heir energy, cool chamber light against a plain bare wall. ${FAR_FUTURE_DRESS} ${NO_TEXT_ANYWHERE}`,
    inference: [],
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Asahi-Iryna, hardline Imperial Celestial archon. ${CELESTIAL_BODY} Tall post-human figure with severe expression, black and crimson archon uniform-robes, ${bloodstone("severe shoulder spur")}, elongated proportions. Ruthless oversight, cold fleet light. ${NO_TEXT_ANYWHERE}`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Acelynn, Chief Archon to the Verak queen and imperial throne. ${CELESTIAL_BODY} Tall post-human Celestial with composed political expression, indigo and silver archon robes, ${bloodstone("mindline crest")}. Senior crown mindline, palace light. ${FAR_FUTURE_DRESS} ${NO_TEXT_ANYWHERE}`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Dagon, Imperial Celestial covert operator posing in human underworld networks. ${CELESTIAL_BODY} Tall elegant man with predatory calm eyes, layered dark merchant coat over subtle high-tech under-armour, elongated post-human proportions barely hidden. ${BLOODSTONE_GUARD}. Dual-face spy, neon underworld bokeh thrown far out of focus with no legible shapes. ${FAR_FUTURE_DRESS} ${NO_TEXT_ANYWHERE}`,
    inference: [],
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Malquilvo, Imperial Celestial court parent in mourning and accusation. ${CELESTIAL_BODY} Tall post-human figure with anguished stern expression, grey court robes, ${bloodstone("set of tear-shaped mourning spurs")}. Tragic court politics, cold public-gallery light. ${NO_TEXT_ANYWHERE}`,
    inference: [
  ...
  },
  {
    ...
    prompt: `${STYLE} Portrait of Uulana as Wynid Imperial Celestial investigator-archon type. ${CELESTIAL_BODY} Tall post-human figure with sharp vigilant eyes, charcoal robes with crimson lining, ${bloodstone("small collar spur")}. Political investigation under threat, tense corridor light. ${NO_TEXT_ANYWHERE}`,
  ...
  },
  {
    ...
    prompt: `${STYLE} Upper-body portrait of Liliana, Lidon-linked human mercenary. HER FIELD KIT IS A BIOWARE MUSCLE SUIT, NOT ARMOUR: a close-fitting lightweight suit of sculpted fibre bundles that reads as exposed anatomy — as though a powerfully built wrestler had been skinned — with NO plates, NO cuirass, NO rigid armour panels and no emblems anywhere on it. HER WEAPON IS A CHERENKOV BLADE: a compact high-tech powered combat knife only about 20cm long, sleek far-future design, thin edge with a faint Cherenkov blue-violet glow when charged, slim tech sheath — NOT a machete, NOT a large sword, NOT a wrapped leather survival knife. Striking woman with a cool professional expression. Deniable operator, unsettling to look at. Windy hatch light and cloud haze. ${NO_TEXT_ANYWHERE}`,
    inference: [
