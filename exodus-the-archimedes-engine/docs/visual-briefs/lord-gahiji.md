...
| **Slug** | `lord-gahiji` |
| **Kind** | character |
| **Clade / type** | Imperial Celestial archon |
| **Role** | Chief Archon to Helena-Chione; political acumen |
| **Image path** | `assets/images/characters/lord-gahiji.jpg` |
...
Grey-and-silver robes of state, ill-fitting; small black-and-green bloodstone cap over the spine patch
