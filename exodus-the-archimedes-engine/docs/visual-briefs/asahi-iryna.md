...
| **Slug** | `asahi-iryna` |
| **Kind** | character |
| **Clade / type** | Imperial Celestial archon (hardline) |
| **Role** | Replaces Makaio’s Wynid oversight under hardliners; pursues Diligent |
| **Image path** | `assets/images/characters/asahi-iryna.jpg` |

## Physical / design cues (research)

- Hardline apparatus archon
- Tall Imperial humanoid
- Navy-adjacent severity

## Clothing / finish

Hardline archon uniform-robes in black and Wynid crimson

## Setting / composition

Fleet command antechamber
