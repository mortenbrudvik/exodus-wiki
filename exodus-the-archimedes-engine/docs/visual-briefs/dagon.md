...
| **Slug** | `dagon` |
| **Kind** | character |
| **Clade / type** | Imperial Celestial operator (Thyra’s uncle) |
| **Role** | Offworld operator in gang networks; Gyvoy imposture network |
| **Image path** | `assets/images/characters/dagon.jpg` |
...
Layered deniable merchant coat over Celestial under-armour, half-shadowed face

## Setting / composition

Santa Rosa underworld night
...
- Wiki article `pages/characters/dagon.html`
