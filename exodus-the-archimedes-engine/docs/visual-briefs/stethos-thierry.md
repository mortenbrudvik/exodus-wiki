# Lord Stethos-Thierry

| Field | Value |
|---|---|
| **Slug** | `stethos-thierry` |
| **Kind** | character |
| **Clade / type** | Imperial Celestial datamaster |
| **Role** | Court datamaster permanently interfaced for Helena-Chione |
| **Image path** | `assets/images/characters/stethos-thierry.jpg` |
...
Data-hall soft hologlyphs (no readable text)
