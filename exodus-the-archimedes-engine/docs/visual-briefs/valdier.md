...
| **Slug** | `valdier` |
| **Kind** | character |
| **Clade / type** | Imperial Celestial elder |
| **Role** | Father of Helena-Chione; Master of the Court |
| **Image path** | `assets/images/characters/valdier.jpg` |

## Physical / design cues (research)

- Older generation of Wynid protocol
- Master of Court formality
- Tall Imperial humanoid elder

## Clothing / finish

Heavy Master of the Court robes, protocol staff-collar of bloodstone

## Setting / composition

Coronation introduction chamber
